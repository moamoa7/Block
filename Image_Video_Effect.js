  ...
  if (!videoWhitelist.includes(currentHost)) {
    GM_addStyle(`
      ...
      video {
        ...
        filter: brightness(1.0500) contrast(0.9500) saturate(0.9000) !important;  // 밝기 1.0555배, 대비 1배, 채도 1.0755배
        -webkit-filter: brightness(1.0500) contrast(0.9500) saturate(0.9000) !important;
      }
      /* 마우스를 올리면 필터 리셋 */
      video:hover {
        opacity: 1;  // 비디오는 항상 불투명
