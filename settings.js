...
(function () {
    ...
    class UIPlugin extends Plugin {
        ...
        renderAllControls() {
            ...
            videoLBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.7); this.stateManager.set('videoFilter.saturation', 104); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -24); this.stateManager.set('videoFilter.highlights', 15); this.stateManager.set('videoFilter.activePreset', 'brighten3'); };
