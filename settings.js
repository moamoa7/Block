...
(function () {
    ...
    const filterManager = (() => {
        ...
        const DESKTOP_SETTINGS = { GAMMA_VALUE: 1.1, SHARPEN_ID: 'Sharpen1', KERNEL_MATRIX: '1 -1 1 -1 -2 -1 1 -1 1', BLUR_STD_DEVIATION: '0.5' };
        const MOBILE_SETTINGS = { GAMMA_VALUE: 1.1, SHARPEN_ID: 'Sharpen7', KERNEL_MATRIX: '-1 -1.125 -1 -1.125 9.75 -1.125 -1 -1.125 -1', BLUR_STD_DEVIATION: '0.5' };
