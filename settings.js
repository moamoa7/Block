...
(function () {
    ...
    const CONFIG = {
        ...
        SPECIFIC_EXCLUSIONS: [],
        MOBILE_FILTER_SETTINGS: { GAMMA_VALUE: 1.04, SHARPEN_ID: 'SharpenDynamic', BLUR_STD_DEVIATION: '0', SHADOWS_VALUE: -1, HIGHLIGHTS_VALUE: 3, SATURATION_VALUE: 110 },
        DESKTOP_FILTER_SETTINGS: { GAMMA_VALUE: 1.04, SHARPEN_ID: 'SharpenDynamic', BLUR_STD_DEVIATION: '0.2', SHADOWS_VALUE: -1, HIGHLIGHTS_VALUE: 3, SATURATION_VALUE: 110 },
        ...
        AUDIO_PRESETS: {
            ...
            liveBroadcast: { name: 'liveBroadcast', gain: 1.15, eq: [{ freq: 80, gain: 2 }, { freq: 150, gain: 1.5 }, { freq: 400, gain: 1 }, { freq: 1000, gain: 3 }, { freq: 2000, gain: 3.5 }, { freq: 3000, gain: 3 }, { freq: 6000, gain: 2 }, { freq: 12000, gain: 2 }] },
    ...
    const speedSlider = (() => {
        ...
        return {
            ...
            clearFadeTimer: () => clearTimeout(fadeOutTimer),
    ...
    const globalUIManager = (() => {
        ...
        function createUIElements() {
            ...
            CONFIG.SPEED_PRESETS.forEach(speed => {
                ...
                btn.addEventListener('click', (e) => {
                    ...
                    if (speedSlider.clearFadeTimer && speedSlider.doFade) {
                        speedSlider.clearFadeTimer();
                        speedSlider.doFade();
                    }
                });
        ...
        function init() {
            ...
            uiContainer.addEventListener('click', (e) => {
                ...
                if (e.target.id === UI_SELECTORS.TRIGGER) {
                    handleTriggerClick();
                }
            });
            attachDragAndDrop();
