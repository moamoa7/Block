...
(function () {
    ...
    const CONFIG = {
        ...
        SPEED_PRESETS: [5.0, 3.0, 2.0, 1.5, 1.2, 1.0, 0.5, 0.2], UI_DRAG_THRESHOLD: 5, UI_WARN_TIMEOUT: 10000,
...
        });
    ...
    renderAllControls() {
        ...
        videoLsharpBtn.onclick = () => {
            this.stateManager.set('videoFilter.level', 15);
            this.stateManager.set('videoFilter.level2', 10);
