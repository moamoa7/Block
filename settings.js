...
(function () {
    ...
    const filterManager = (() => {
        ...
        const MOBILE_SETTINGS = { GAMMA_VALUE: 1.05, SHARPEN_ID: 'Sharpen6', KERNEL_MATRIX: '-1 -1.25 -1 -1.25 11 -1.25 -1 -1.25 -1', BLUR_STD_DEVIATION: '0.4', SHADOWS_VALUE: 0 };
...
`;
    ...
    return {
        ...
        show: () => {
            const el = uiManager.getShadowRoot()?.getElementById('vm-speed-slider-container');
