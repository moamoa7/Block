...
(function () {
    ...
    class UIPlugin extends Plugin {
        ...
        renderAllControls() {
            ...
            videoSBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.50); this.stateManager.set('videoFilter.saturation', 100); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -10); this.stateManager.set('videoFilter.highlights', 5); this.stateManager.set('videoFilter.activePreset', 'brighten1'); };
            ...
            videoMBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.75); this.stateManager.set('videoFilter.saturation', 102); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -14); this.stateManager.set('videoFilter.highlights', 7); this.stateManager.set('videoFilter.activePreset', 'brighten2'); };
            ...
            videoLBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 2.00); this.stateManager.set('videoFilter.saturation', 104); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -20.0); this.stateManager.set('videoFilter.highlights', 10); this.stateManager.set('videoFilter.activePreset', 'brighten3'); };
