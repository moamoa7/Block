...
(function () {
    ...
    const speedSlider = (() => {
        ...
        function init() {
            ...
            sliderEl.addEventListener('input', (e) => { const speed = parseFloat(e.target.value); applySpeed(speed); updateValueText(speed); container.classList.add('touched'); clearTimeout(fadeOutTimer); });
