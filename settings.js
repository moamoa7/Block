...
(function () {
    ...
    class UIPlugin extends Plugin {
        ...
        renderAllControls() {
            ...
            videoXMBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.40); this.stateManager.set('videoFilter.saturation', 101); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -12.6); this.stateManager.set('videoFilter.highlights', 7); this.stateManager.set('videoFilter.activePreset', 'brightenX2'); };
