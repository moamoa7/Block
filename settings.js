...
(function () {
    ...
    const CONFIG = {
        ...
        SPEED_PRESETS: [3.5, 3.0, 2.5, 2.0, 1.0, 0.5, 0.2], UI_DRAG_THRESHOLD: 5, UI_WARN_TIMEOUT: 10000,
        ...
        EXCLUSION_KEYWORDS: ['login', 'signin', 'auth', 'captcha', 'signup', 'sign_in', 'register', 'download', 'forgot', 'fredl.ru', 'frdl.my', 'financemonk', 'up4load.com', 'liteapks.com', 'drive.google.com', 'discord.com', 'github.com', 'chatgpt.com', 'yako.gg', 'yasyadong.cc', 'jpupskirts.club', 'avpingyou', 'newtoki', 'manatoki', 'booktoki', 'sextb.date'],
