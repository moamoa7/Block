...
(function () {
    ...
    class UIPlugin extends Plugin {
        ...
        renderAllControls() {
            ...
            videoXSBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.35); this.stateManager.set('videoFilter.saturation', 100); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -9); this.stateManager.set('videoFilter.highlights', 5); this.stateManager.set('videoFilter.activePreset', 'brightenX1'); };
            ...
            videoXMBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.50); this.stateManager.set('videoFilter.saturation', 104); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -12.6); this.stateManager.set('videoFilter.highlights', 7); this.stateManager.set('videoFilter.activePreset', 'brightenX2'); };
            ...
            videoXLBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.65); this.stateManager.set('videoFilter.saturation', 108); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -18); this.stateManager.set('videoFilter.highlights', 10); this.stateManager.set('videoFilter.activePreset', 'brightenX3'); };
            ...
            videoXXBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.80); this.stateManager.set('videoFilter.saturation', 112); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -27); this.stateManager.set('videoFilter.highlights', 15); this.stateManager.set('videoFilter.activePreset', 'brightenX4'); };
