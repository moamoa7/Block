...
(function () {
    ...
    class UIPlugin extends Plugin {
        ...
        renderAllControls() {
            ...
            videoXSBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.20); this.stateManager.set('videoFilter.saturation', 102); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -17); this.stateManager.set('videoFilter.highlights', 10); this.stateManager.set('videoFilter.activePreset', 'brightenX1'); };
            ...
            videoXMBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.50); this.stateManager.set('videoFilter.saturation', 104); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -34); this.stateManager.set('videoFilter.highlights', 20); this.stateManager.set('videoFilter.activePreset', 'brightenX2'); };
            ...
            videoXLBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 1.80); this.stateManager.set('videoFilter.saturation', 106); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -51); this.stateManager.set('videoFilter.highlights', 30); this.stateManager.set('videoFilter.activePreset', 'brightenX3'); };
            ...
            videoXXBrightenBtn.onclick = () => { this.stateManager.set('videoFilter.gamma', 2.10); this.stateManager.set('videoFilter.saturation', 108); this.stateManager.set('videoFilter.blur', 0); this.stateManager.set('videoFilter.shadows', -68); this.stateManager.set('videoFilter.highlights', 40); this.stateManager.set('videoFilter.activePreset', 'brightenX4'); };
