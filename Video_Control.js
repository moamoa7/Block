...
const MANUAL_PRESETS = [
    ...
    { n: '시네마(약)',   v: [0, 0, 0,  0, 0, -3,  -1,  3,  -2] },
    { n: '시네마(보통)', v: [0, 0, 0,  0, 0, -6,  -2,  5,  -3] },
    { n: '시네마(중간)', v: [0, 0, 0,  0, 0, -9,  -3,  7,  -5] },
    { n: '시네마(강)',   v: [0, 0, 0,  0, 0, -12, -4,  9,  -7] },
    { n: '시네마(최대)', v: [0, 0, 0,  0, 0, -15, -5,  11, -9] },
