...
(function () {
  ...
  const MANUAL_PRESETS = [
    ...
    { n: '인핸스(약)',   v: [20, 14, 10, 0, 0, -1,  -3,  4,  6] },
    { n: '인핸스(보통)', v: [40, 27, 20, 0, 0, -3,  -6,  7, 11] },
    { n: '인핸스(중간)', v: [60, 41, 30, 0, 0, -4,  -9, 11, 17] },
    { n: '인핸스(강)',   v: [80, 54, 40, 0, 0, -6, -11, 14, 23] },
    { n: '인핸스(최대)', v: [100, 60, 44, 0, 0, -6, -12, 15, 25] },
  ];
