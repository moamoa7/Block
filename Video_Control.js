...
    const SHADOW_TABLES = {
  // 블랙 -2 (중간 복원): 1단보다 조금 더 배경을 맑게 (얼굴 보호)
  1: '0 0.20 0.33 0.50 0.68 0.85 1',

  // 블랙 -1 (약한 복원): 미세하게 안개만 걷어내는 투명함 (얼굴 보호)
  2: '0 0.17 0.32 0.50 0.68 0.85 1',

  // 블랙 +1 (미세 압축): 회색기를 없애고 블랙을 단단하게 잡음 (복원 없음)
  // 원본(0.16)보다 아주 살짝만 낮춰서 인위적인 느낌 없이 쫀쫀하게만 만듭니다.
  3: '0 0.14 0.31 0.49 0.67 0.84 1'
};
