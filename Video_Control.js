// ==UserScript==
// @name         Video_Control (v192.0.0)
// @namespace    https://github.com/
// @version      192.0.0
// @description  v192: dual-path sharpening (PC SVG isotropic + Mobile CSS pseudo-sharp), audio param tuning, CLAHE/color correction refinement, targeting rebalance, edge-case hardening, UI polish.
// @match        *://*/*
...
b.onclick = () => {
    ...
    if (key === P.V_PRE_S && sm.get(P.APP_AUTO_PRESET)) {
      ...
      const build = () => {
        ...
        const style = `:host{all:initial}*{box-sizing:border-box}.panel{position:fixed!important;top:50%!important;right:68px!important;transform:translateY(-50%)!important;width:min(320px, calc(100vw - 80px))!important;background:rgba(18,18,22,0.97)!important;backdrop-filter:blur(16px) saturate(180%)!important;color:#e8e8ec!important;padding:0!important;border-radius:14px!important;z-index:2147483647!important;border:1px solid rgba(255,255,255,0.08)!important;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',system-ui,sans-serif!important;box-shadow:0 24px 80px rgba(0,0,0,0.6),0 0 0 1px rgba(255,255,255,0.05) inset!important;overflow:hidden!important;max-height:min(90vh, 500px)!important;display:flex!important;flex-direction:column!important}.header{padding:14px 16px 12px;cursor:move;user-select:none;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;align-items:center;justify-content:space-between;gap:8px;background:linear-gradient(180deg, rgba(255,255,255,0.03) 0%, transparent 100%)}.header-title{font-size:13px;font-weight:700;color:rgba(255,255,255,0.9)}.header-info{font-size:10px;color:rgba(255,255,255,0.3);flex:1;text-align:center}.tab-bar{display:flex;border-bottom:1px solid rgba(255,255,255,0.06);padding:0 8px}.tab{flex:1;padding:8px 4px 6px;text-align:center;cursor:pointer;border-bottom:2px solid transparent;font-size:10px;font-weight:600;color:rgba(255,255,255,0.4)}.tab.active{color:#60a5fa;border-bottom-color:#3b82f6;background:rgba(59,130,246,0.06)}.tab-content{display:none;padding:10px 12px;overflow-y:auto;flex:1}.tab-content.active{display:block}.section{margin-bottom:10px;padding:10px;background:rgba(255,255,255,0.03);border-radius:10px}.row{display:flex;gap:4px;margin-bottom:4px;align-items:center}.btn{flex:1;height:36px;border:1px solid rgba(255,255,255,0.10);border-radius:8px;background:rgba(255,255,255,0.06);color:rgba(255,255,255,0.82);cursor:pointer;font-size:12px;font-weight:600}.btn.active{background:rgba(59,130,246,0.25);border-color:rgba(59,130,246,0.5);color:#60a5fa}.btn-sm{height:30px;font-size:11px}.preset-btn{flex:1;height:32px;border:1px solid rgba(255,255,255,0.08);border-radius:6px;background:rgba(255,255,255,0.04);color:rgba(255,255,255,0.65);cursor:pointer;font-size:11px}.preset-btn.active{background:rgba(245,158,11,0.20);border-color:rgba(245,158,11,0.5);color:#fbbf24}.footer{padding:8px 12px;border-top:1px solid rgba(255,255,255,0.06);display:flex;gap:4px}@media(max-width:520px){.panel{width:min(280px, calc(100vw - 72px))!important;right:60px!important;max-height:min(85vh, 450px)!important}}`;
      ...
      const ensureGear = () => {
        ...
        const style = `.gear{--size:44px;position:fixed!important;bottom:max(20px, calc(env(safe-area-inset-bottom, 0px) + 16px))!important;right:max(16px, calc(env(safe-area-inset-right, 0px) + 16px))!important;top:auto!important;transform:none!important;width:var(--size)!important;height:var(--size)!important;border-radius:50%!important;background:rgba(25,25,30,0.95)!important;backdrop-filter:blur(12px)!important;border:1.5px solid rgba(255,255,255,0.15)!important;color:#fff!important;display:flex!important;align-items:center!important;justify-content:center!important;cursor:pointer!important;pointer-events:auto!important;z-index:2147483647!important;box-shadow:0 4px 20px rgba(0,0,0,0.4)!important;user-select:none!important;-webkit-tap-highlight-color:transparent!important;transition:transform 0.15s ease, box-shadow 0.15s ease, opacity 0.2s!important;opacity:1!important}.gear:active{transform:scale(0.9)!important}.gear.open{border-color:#2ed573!important;box-shadow:0 4px 20px rgba(0,0,0,0.4), 0 0 0 3px rgba(46,213,115,0.2)!important}.gear.inactive{border-color:#ff4757!important;opacity:0.7!important}.gear:not(.open):not(.inactive){opacity:0.55!important}.gear.panel-open{opacity:0!important;pointer-events:none!important;transform:scale(0.8)!important}@media(min-width:768px){.gear{bottom:auto!important;top:50%!important;transform:translateY(-50%)!important}.gear:active{transform:translateY(-50%) scale(0.9)!important}.gear.panel-open{transform:translateY(-50%) scale(0.8)!important}}.status-badge{position:absolute;top:0;right:0;min-width:14px;height:14px;border-radius:7px;background:#3b82f6;color:#fff;font-size:9px;font-weight:800;display:flex;align-items:center;justify-content:center}.hint{display:none}`;
        applyShadowStyle(shadow, style, h);
