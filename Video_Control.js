...
(function () {
  ...
  const MANUAL_PRESETS = [
    ...
    { n: '뽀샤시(약)', v: [0, 0,  0,  0, 0,  0,  0,  0,  3] },
    { n: '뽀샤시(보통)', v: [0, 0,  0,  0, 0,  0,  0,  0,  6] },
    { n: '뽀샤시(중간)', v: [0, 0,  0,  0, 0,  0,  0,  0,  9] },
    { n: '뽀샤시(강)', v: [0, 0,  0,  0, 0,  0,  0,  0,  12] },
    { n: '뽀샤시(최대)', v: [0, 0,  0,  0, 0,  0,  0,  0,  15] },
    ...
    { n: '시네마(중간)', v: [0, 0, 6, -8,  0,  -6,  -6,  3,  18] },
    { n: '시네마(강)',   v: [0, 0, 8, -12, 0, -8, -8, 4, 24] },
    { n: '시네마(최대)', v: [0, 0, 10, -15, 0, -10, -10, 5, 30] },
  ];
