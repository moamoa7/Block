...
(function () {
  ...
  const MANUAL_PRESETS = [
    ...
    { n: '사용자10', v: [10, 10, 1,  0, 0,  0,  0, 0, 0] },
    { n: '사용자20', v: [20, 15, 1,  0, 0, -1, -1, 1, 1] },
    { n: '사용자30', v: [30, 20, 2,  0, 0, -2, -2, 2, 2] },
    { n: '사용자40', v: [40, 25, 2,  0, 0, -3, -3, 3, 3] },
    { n: '사용자50', v: [50, 30, 3,  0, 0, -4, -4, 4, 4] },
    { n: '사용자60', v: [60, 35, 3,  0, 0, -5, -5, 5, 5] },
    { n: '사용자70', v: [70, 40, 4,  0, 0, -6, -6, 6, 6] },
    { n: '사용자80', v: [80, 45, 4,  0, 0, -7, -7, 7, 7] },
    { n: '사용자90', v: [90, 50, 5,  0, 0, -8, -8, 8, 8] },
    { n: '사용자100', v: [100, 55, 5,  0, 0, -9, -9, 9, 9] },
  ];
  ...
  function createAutoScene(store, scheduler) {
    ...
    const DRM_BASE = [ 30, 20,  2,  0, 0, -2, -2,  2,  2 ];
