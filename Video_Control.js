...
const MANUAL_PRESETS = [
  ...
  { n: '자연(중립)',    v: [ 4,  2,  2,  0,  0, -4,   4,   2,   0] },
  { n: '보정',    v: [ 6,  4,  6,  4,  0,  4,   6,   6,   6] },
  { n: '헤이즈제거', v: [ 0,  0,  0, -8,  0, -6, -10,  28,   4] },
  { n: '저화질', v: [ 0,  0,  6,  0,  0, 12,  -4,  12,   6] },
  { n: '모바일', v: [ 0,  0, 10,  0,  0,  8,  -6,  14,   8] },
  { n: '낮/실내', v: [ 0,  0, 10,  0,  0,  4,   0,  18,  12] },
  { n: '광명*', v: [ 0,  0,  0,  0,  0,  0,  -24,  24,  24] },
  { n: '야외(햇빛)', v: [ 0, 0, 0, 0, 0, -12, -8, 24, 0] },
  { n: '역광', v: [40, 0, 15, 0, 0, 0, 12, 8, -8] },
  { n: '뽀샤시*', v: [ 0, 0, 12, 0, 0, 0, 4, 8, 16] },
  { n: '게임(총)', v: [ 0,  0,  16,  0,  0,  0,  -8,  -16,  8] },
  { n: '게임(전략)', v: [ 0,  0,  8, -4,  0,  6,  -6,  20,   6] },
  { n: '격투(격투)', v: [ 0,  0,  6,  0,  0, 18,  -4,  18,   8] },
  { n: '게임(rpg)',   v: [ 0,  0, 14,  6,  0, 18,   2,  -4,   8] },
  { n: '게임(스포츠)', v: [ 0,  0, 10,  4,  0, 10,  -4,  12,   8] },
  { n: '애니', v: [  0,  0,  6,  0,  0,  8,  4,  10,  3] },
  { n: '필름', v: [14,  0,  4,  8, -2, -12,  8,   4,   3] },
  { n: '블버(일반)', v: [ 0,  0,  8, -4,  0, -6,  4,  12,   6] },
  { n: '블버(다크)', v: [ 0,  0,  10, -5,  0, -5,  10,  10,   10] },
  { n: '저조도영상', v: [24, 12,  8,  0,  0,  4,   8,  -4,  12] },
  { n: '복구*', v: [48, 0,  20,  0,  0,  0,  12,  8,  16] },
