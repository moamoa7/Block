...
(function () {
  ...
  const MANUAL_PRESETS = [
    ...
    { n: '내추럴(약)', v: [20, 0,  0,  0, 0,  0,  0,  0,  0] },
    { n: '내추럴(보통)', v: [40, 0,  0,  0, 0,  0,  0,  0,  0] },
    { n: '내추럴(중간)', v: [60, 0,  0,  0, 0,  0,  0,  0,  0] },
    { n: '내추럴(강)', v: [80, 0,  0,  0, 0,  0,  0,  0,  0] },
    { n: '내추럴(최대)', v: [100, 0,  0,  0, 0,  0,  0,  0,  0] },

    { n: '뽀샤시(약)', v: [20, 0,  0,  0, 0,  0,  0,  0,  3] },
    { n: '뽀샤시(보통)', v: [40, 0,  0,  0, 0,  0,  0,  0,  6] },
    { n: '뽀샤시(중간)', v: [60, 0,  0,  0, 0,  0,  0,  0,  9] },
    { n: '뽀샤시(강)', v: [80, 0,  0,  0, 0,  0,  0,  0,  12] },
    { n: '뽀샤시(최대)', v: [100, 0,  0,  0, 0,  0,  0,  0,  15] },

    { n: '마스터(약)',   v: [25, 0,  3, 0, 0, 0,  -3,  3,  2] },
    { n: '마스터(보통)', v: [45, 0,  6, 0, 0, 0,  -5,  5,  4] },
    { n: '마스터(중간)', v: [60, 0, 10, 0, 0, 0,  -6,  7,  6] },
    { n: '마스터(강)',   v: [75, 0, 14, 0, 0, 0,  -8,  9,  8] },
    { n: '마스터(최대)', v: [90, 0, 18, 0, 0, 0, -10, 10, 10] },

    { n: '시네마(약)', v: [20, 0, 5,   0,  0,  -2,  -2,   4,   4] },
    { n: '시네마(보통)', v: [40, 0, 10,   0,  0,  -4,  -4,   7,   8] },
    { n: '시네마(중간)', v: [60, 0, 15,  -2,  0,  -6,  -6,  10,  12] },
    { n: '시네마(강)',   v: [80, 0, 20, -4, 0, -8, -8, 13, 16] },
    { n: '시네마(최대)', v: [100, 0, 25, -5, 0, -10, -10, 16, 20] },
