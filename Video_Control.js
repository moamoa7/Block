...
(function () {
  ...
  const MANUAL_PRESETS = [
    ...
    { n: '시네마(약)',   v: [20, 0, 4, 0, 0,  -2,  -3,  1,  5] },
    { n: '시네마(보통)', v: [35, 0, 8, 0, 0,  -4,  -6,  2, 10] },
    { n: '시네마(중간)', v: [50, 0, 12, 0, 0,  -6,  -9,  3, 15] },
    { n: '시네마(강)',   v: [65, 0, 16, 0, 0,  -8,  -12,  4, 20] },
    { n: '시네마(최대)', v: [80, 0, 20, 0, 0,  -10,  -15,  5, 25] },
  ];
