...
    const SHADOW_TABLES = { 
  // 블랙 -2 (중간 복원): 얼굴은 보호하면서 어두운 배경만 투명하게
  // (0.21로 시작하되 0.35로 빠르게 꺾어 얼굴 톤 침범 방지)
  1: '0 0.21 0.35 0.52 0.70 0.86 1', 

  // 블랙 -1 (약한 복원): 모바일 광현상 차단용 세팅
  // (0.17로 시작하여 얼굴이 위치한 중간 영역은 원본과 거의 같게 유지)
  2: '0 0.17 0.32 0.51 0.69 0.85 1', 

  // 블랙 +1 (미세 암부): 기존 유지
  3: '0 0.12 0.28 0.46 0.64 0.82 1'  
};
