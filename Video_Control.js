...
(function () {
  ...
  const MANUAL_PRESETS = [
    ...
    { n: '사용자10', v: [10, 10,  5,  0, 0,  0, -1,  0,  2] },
    { n: '사용자20', v: [15, 12,  6,  0, 0, -1, -1,  0,  3] },
    { n: '사용자30', v: [20, 15,  8,  0, 0, -1, -1,  0,  4] },
    { n: '사용자40', v: [25, 18, 10,  0, 0, -2, -2,  0,  5] },
    { n: '사용자50', v: [30, 20, 12,  0, 0, -2, -2,  0,  6] },
    { n: '사용자60', v: [35, 23, 14,  0, 0, -3, -3,  0,  7] },
    { n: '사용자70', v: [40, 26, 16,  0, 0, -3, -3,  0,  8] },
    { n: '사용자80', v: [45, 28, 18,  0, 0, -4, -4,  0,  9] },
    { n: '사용자90', v: [48, 29, 19,  0, 0, -4, -4,  0, 10] },
    { n: '사용자100', v: [50, 30, 20, 0, 0, -4, -4,  0, 11] },
];
