// ==UserScript==
// @name         Video_Control (v182.5 - EventBus & Feature Architecture)
...
function VSC_MAIN() {
  ...
  const PRESETS = Object.freeze({
    detail: {
      ...
      Master: { sharpAdd: 52, sharp2Add: 48, sat: 0.98, microBase: 0.20, microScale: 1/90, fineBase: 0.32, fineScale: 1/18, microAmt: [0.55, 0.14], fineAmt: [0.22, 0.90] }
    },
    bright: {
