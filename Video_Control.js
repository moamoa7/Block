...
(function () {
  ...
  const MANUAL_PRESETS = [
    ...
    { n: '약하게',      v: [20, 15,   0,   0,   0,  -1,  -1,   1,   1] },
    { n: '보통',        v: [40, 25,   2,   0,   0,  -3,  -3,   3,   3] },
    { n: '강하게',      v: [65, 38,   5,   0,   0,  -6,  -6,   6,   6] },
    { n: '최대',        v: [100, 55,  8,   0,   0,  -9,  -9,   9,   9] },
  ];
    ...
    function purge(root) {
      ...
      if (ctx) {
        ...
        try {
          ...
          for (const v of videos) appliedFilter.delete(v);
        } catch (_) {}
      }
    }
