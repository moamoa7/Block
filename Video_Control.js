...
const MANUAL_PRESETS = [
  ...
  { n: '만능보정',    v: [ 6,  4,  6,  4,  0,  4,   6,   6,   6] },
  { n: '눈편함',    v: [ 4,  0,  0,  8,  0, -8,   4,  -6,  -6] },
  { n: '밝게',  v: [ 0,  0,  0,  0,  0,  0,  14,   0,  14] },
  { n: '광명', v: [ 0,  0,  0,  0,  0,  0,  -24,  24,  24] },

  // ── 환경/조명 ──
  { n: '낮/실내', v: [ 0,  0, 10,  0,  0,  4,   0,  18,  12] },
  { n: '강한직사광', v: [ 0, 0, 0, 0, 0, -12, -8, 24, 0] },
  { n: '극한암부',      v: [32, 10, 12,  4,  0,  0,   8,  -6,  14] },

  // ── 콘텐츠/장치 ──
  { n: '라이브선명', v: [ 6,  4,  6, -2,  0,  4,  -4,  14,   6] },
  { n: '모바일', v: [ 0,  0, 10,  0,  0,  8,  -6,  14,   8] },

  // ── 문제 해결 ──
  { n: '저비트보정', v: [12,  8,  4,  0,  0, -2,   4,   8,   4] },
  { n: '과노출영상', v: [ 0,  0,  0,  0,  0,  0,   4,  10, -18] },
  { n: '역광보정', v: [40, 0, 15, 0, 0, 0, 12, 8, -8] },
  { n: '안개제거',      v: [ 0,  0,  0, -8,  0, -6, -10,  28,   4] },
