...
// @version      31.5.2
// @description  v31.5.2: 시네마톤 재설정 - 장시간 시청시 눈이 피로하지 않는걸 목적으로 변경
// @match        *://*/*
...
const MANUAL_PRESETS = [
    ...
    { n: '시네마(약)',   v: [0, 0, 0,  0, 0, -4,   0,  1,  -1] },
    { n: '시네마(보통)', v: [0, 0, 0,  0, 0, -7,  -1,  2,  -2] },
    { n: '시네마(중간)', v: [0, 0, 0,  0, 0, -10, -2,  3,  -3] },
    { n: '시네마(강)',   v: [0, 0, 0,  0, 0, -13, -3,  4,  -5] },
    { n: '시네마(최대)', v: [0, 0, 0,  0, 0, -16, -4,  5,  -7] },
