// ==UserScript==
// @name         Video_Control (v180.4.0 - Perf Governor + Dual USM + AudioWorklet + PiP UX + Zoom3D + RenderOpt)
...
// ==== [PART 3 START] ====
  ...
  function createBackendAdapter(Filters) {
    return {
      // [D-2 적용] 프레임 드롭 감지 시 SVG 필터를 비활성화하고 가벼운 CSS로 임시 전환
