...
// @version      31.5.3
// @description  v31.5.3 : 시네마톤 재설정 - 장시간 시청시 눈이 피로하지 않는걸 목적으로 변경
// @match        *://*/*
...
const MANUAL_PRESETS = [
    ...
    { n: '시네마(약)',   v: [3,  0, 0, 2, 0, -4,  0, -1, -2] },
    { n: '시네마(보통)', v: [5,  0, 0, 3, 0, -7, -1, -2, -3] },
    { n: '시네마(중간)', v: [7,  0, 0, 4, 0,-10, -2, -3, -4] },
    { n: '시네마(강)',   v: [9,  0, 0, 5, 0,-13, -3, -4, -6] },
    { n: '시네마(최대)', v: [12, 0, 0, 6, 0,-16, -4, -5, -8] },

    { n: '복원(약)',   v: [0, 0, 5, 0, 0,  -2,  -2,  1,  6] },
    { n: '복원(보통)', v: [0, 0, 10, 0, 0,  -3,  -4,  2, 13] },
    { n: '복원(중간)', v: [0, 0, 15, 0, 0,  -4,  -6,  3, 18] },
    { n: '복원(강)',   v: [0, 0, 18, 0, 0,  -5,  -8,  4, 21] },
    { n: '복원(최대)', v: [0, 0, 21, 0, 0,  -6,  -10,  5, 24] },
  ];
