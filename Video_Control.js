...
(function () {
  ...
  const MANUAL_PRESETS = [
    ...
    { n: '선명(약)', v: [20, 16,  5,  0, 0,  2, -2,  3,  2] },
    { n: '선명(보통)', v: [40, 30, 10,  0, 0,  4, -4,  6,  5] },
    { n: '선명(중간)', v: [60, 42, 15,  0, 0,  6, -6,  9,  8] },
    { n: '선명(강)',   v: [80, 52, 20, 0, 0, 8, -8, 12, 11] },
    { n: '선명(최대)', v: [100, 60, 25, 0, 0, 10, -10, 15, 14] },
